...
This is my fork of the Stability Diffusion 3.5 from https://github.com/Stability-AI/sd3.5, with minor modifications and additional scripts supporting NVIDIA Blackwell architecture, Intel ARC architecture, and Apple M-series SoC with Metal Performance Shaders (MPS)
